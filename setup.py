...
setup(
    ...
    download_url='https://github.com/n3011/tefla/tarball/1.2.0',
    ...
    install_requires=['numpy==1.11.1', 'pandas==0.18.1', 'SharedArray==1.0', 'click==6.6', 'scikit-image==0.12.3',
                      'scikit-learn==0.18.2', 'six==1.10.0', 'setuptools==28.8.0', 'matplotlib==1.5.1', 'ghalton==0.6', 'Pillow==2.3.0', 'progress'],
    test_suite='tests',
