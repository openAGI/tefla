...
setup(
    ...
    download_url='https://github.com/openAGI/tefla/archive/1.7.0.zip',
    keywords=['tensorflow', 'deeplearning', 'cnn', 'deepcnn'],
    classifiers=[],
    install_requires=['numpy>=1.11.1', 'pandas==0.18.1', 'matplotlib==2.0.2', 'SharedArray==1.0', 'click==6.6', 'scikit-image==0.12.3',
                      'scikit-learn==0.18.2', 'six==1.10.0', 'setuptools==28.8.0', 'ghalton==0.6', 'Pillow==2.3.0', 'progress', 'opencv-python', 'pyyaml', 'portpicker'],
    test_suite='tests',
