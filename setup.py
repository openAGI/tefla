...
setup(
    ...
    download_url='https://github.com/openAGI/tefla/archive/1.8.4.zip',
    keywords=['tensorflow', 'deeplearning', 'cnn', 'deepcnn'],
    classifiers=[],
    install_requires=['numpy>=1.11.1', 'pandas', 'matplotlib==2.2.3', 'SharedArray==3.0.0', 'click==6.6', 'scikit-image==0.12.3',
