...
def resnet_v1(inputs, is_training, reuse,
              blocks,
              num_classes=None,
              global_pool=True,
              output_stride=None,
...
def resnet_v1_50(inputs, is_training, reuse,
                 num_classes=None,
                 global_pool=True,
                 output_stride=None,
                 name='resnet_v2_50'):
    ...
    return resnet_v1(inputs, is_training, reuse, blocks, num_classes,
                     global_pool=global_pool, output_stride=output_stride,
                     include_root_block=True, name=name)


def resnet_v1_101(inputs, is_training, reuse,
                  num_classes=None,
                  global_pool=True,
                  output_stride=None,
                  name='resnet_v2_101'):
...
def resnet_v1_152(inputs, is_training, reuse,
                  num_classes=None,
                  global_pool=True,
                  output_stride=None,
                  name='resnet_v2_152'):
...
def resnet_v1_200(inputs, is_training, reuse,
                  num_classes=None,
                  global_pool=True,
                  output_stride=None,
                  name='resnet_v2_200'):
