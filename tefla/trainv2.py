...
@click.option('--is_summary', default=False, show_default=True,
              help='Path to initial weights file.')
def main(model, training_cnf, data_dir, parallel, max_to_keep, start_epoch, weights_from, num_classes, resume_lr, gpu_memory_fraction, is_summary, loss_type):
    ...
    learner.fit(data_dir_train, data_dir_val, weights_from=weights_from, max_to_keep=max_to_keep, start_epoch=start_epoch, training_set_size=50000, val_set_size=10000,
