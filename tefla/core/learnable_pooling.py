...
class PoolingBaseModel(object):
    ...
    def __init__(self, feature_size, max_samples, cluster_size, output_dim,
                 gating=True, add_batch_norm=True, is_training=True, name='LearnablePooling', outputs_collections=None):
...
class NetVLAD(PoolingBaseModel):
    ...
    def __init__(self, feature_size, max_samples, cluster_size, output_dim, **kwargs):
        ...
        Args:
            ...
            outputs_collections: The collections to which the outputs are added.
        """
        super(self.__class__, self).__init__(feature_size,
                                             max_samples, cluster_size, output_dim, **kwargs)
