...
@click.command()
@click.option('--checkpoints', default='', show_default=True,
              help="Comma-separated list of checkpoints to average.")
@click.option('--weights', default=None, show_default=True,
              help="Comma-separated list of weights for corresponding checkpoints.")
@click.option('--prefix', default=None, show_default=True,
              help="Prefix (e.g., directory) to append to each checkpoint.")
@click.option('--output_path', default='data/train', show_default=True,
