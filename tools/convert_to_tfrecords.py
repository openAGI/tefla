...
@click.option(
    '--records_name',
    default='dataset_serealized',
    show_default=True,
    help="TFRecords output file name.")
@click.option('--num_shards', default=8, show_default=True, help="Number of shards for database.")
@click.option(
    '--data_dir', default='data/train', show_default=True, help="Datset dir with jpeg/png images.")
@click.option(
    '--output_data_dir',
    default='data/train',
    show_default=True,
    help="Datset dir with jpeg/png images.")
@click.option('--label_file', show_default=True, help="Path to the label file.")
