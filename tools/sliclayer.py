...
@click.option(
    '--num_segments', default=50, show_default=True, help="Number of segmented region for slic")
@click.option('--num_clusters', default=30, show_default=True, help="Num clusters")
@click.option('--image_size', default=448, show_default=True, help="Size of converted images.")
