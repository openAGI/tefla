...
@click.command()
@click.option(
    '--model', default='models/c_multiclass.py', show_default=True, help='Relative path to model.')
@click.option(
    '--model_cnf', default=None, show_default=True, help='Relative path to training config file.')
@click.option(
    '--layer_name',
    default='conv2_1',
    show_default=True,
