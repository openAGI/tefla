# coding=utf-8
# Copyright 2017 The Tensor2Tensor  and Tefla Authors.
#
...
"""Tests for tefla.dataset.text_encoder."""
...
from tefla.dataset import text_encoder
...
class TokenTextEncoderTest(tf.test.TestCase):
  ...
  def test_reserved_tokens_in_corpus(self):
    ...
    corpus = "A B {} D E F {} G {}".format(text_encoder.EOS, text_encoder.EOS, text_encoder.PAD)
...
class SubwordTextEncoderTest(tf.test.TestCase):
  ...
  def test_encode_decode(self):
    ...
    encoder = text_encoder.SubwordTextEncoder.build_to_target_size(100, token_counts, 2, 10)
  ...
  def test_small_vocab(self):
    ...
    encoder = text_encoder.SubwordTextEncoder.build_to_target_size(10, token_counts, 2, 10)
