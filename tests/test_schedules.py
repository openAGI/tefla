...
class SchedulesTest(tf.test.TestCase):
    ...
    def testConstSchedule(self):
        self.ScheduleTestHelper(
            schedules.Config(fn='const', const=5),
            schedules.ConstSchedule,
            [(0, 5), (1, 5), (10, 5), (20, 5), (100, 5), (1000000, 5)])

    def testLinearDecaySchedule(self):
        self.ScheduleTestHelper(
            schedules.Config(fn='linear_decay', initial=2, final=0, start_time=10,
                             end_time=20),
    ...
    def testExponentialDecaySchedule(self):
        self.ScheduleTestHelper(
            schedules.Config(fn='exp_decay', initial=exp(-1), final=exp(-6),
    ...
    def testSmootherstepDecaySchedule(self):
        self.ScheduleTestHelper(
            schedules.Config(fn='smooth_decay', initial=2, final=0, start_time=10,
                             end_time=20),
    ...
    def testHardOscillatorSchedule(self):
        self.ScheduleTestHelper(
            schedules.Config(fn='hard_osc', high=2, low=0, start_time=100,
