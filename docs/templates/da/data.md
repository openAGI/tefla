...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.fast_warp</b></span>  (img,  tf,  output_shape,  mode='constant',  mode_cval=0,  order=0)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.contrast_transform</b></span>  (img,  contrast_min=0.8,  contrast_max=1.2)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.brightness_transform</b></span>  (img,  brightness_min=0.93,  brightness_max=1.4)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.build_rescale_transform_slow</b></span>  (downscale_factor,  image_shape,  target_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.build_rescale_transform_fast</b></span>  (downscale_factor,  image_shape,  target_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.build_centering_transform</b></span>  (image_shape,  target_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.build_center_uncenter_transforms</b></span>  (image_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.build_augmentation_transform</b></span>  (zoom=  (1.0,  1.0),  rotation=0,  shear=0,  translation=  (0,  0),  flip=False)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.random_perturbation_transform</b></span>  (zoom_range,  rotation_range,  shear_range,  translation_range,  do_flip=True,  allow_stretch=False,  rng=<module  'numpy.random'  from  '/home/ishant/.local/lib/python2.7/site-packages/numpy/random/__init__.pyc'>)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.definite_crop</b></span>  (img,  bbox)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.perturb</b></span>  (img,  augmentation_params,  target_shape,  rng=<module  'numpy.random'  from  '/home/ishant/.local/lib/python2.7/site-packages/numpy/random/__init__.pyc'>,  mode='constant',  mode_cval=0)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.perturb_rescaled</b></span>  (img,  scale,  augmentation_params,  target_shape=  (224,  224),  rng=<module  'numpy.random'  from  '/home/ishant/.local/lib/python2.7/site-packages/numpy/random/__init__.pyc'>,  mode='constant',  mode_cval=0)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.perturb_fixed</b></span>  (img,  tform_augment,  target_shape=  (50,  50),  mode='constant',  mode_cval=0)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.image_no_preprocessing</b></span>  (fname)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.load_images</b></span>  (imgs,  preprocessor=<function  image_no_preprocessing  at  0x7f97cfc2f050>)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.load_image</b></span>  (img,  preprocessor=<function  image_no_preprocessing  at  0x7f97cfc2f050>)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.save_image</b></span>  (x,  fname)</span>
...
<span class="extra_h1"><span style="color:black;"><b>tefla.da.data.balance_per_class_indices</b></span>  (y,  weights)</span>
