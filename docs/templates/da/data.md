...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L32 target="_blank"><b>tefla.da.data.fast_warp</b></a></span>  (img,  tf,  output_shape,  mode='constant',  mode_cval=0,  order=0)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L63 target="_blank"><b>tefla.da.data.contrast_transform</b></a></span>  (img,  contrast_min=0.8,  contrast_max=1.2)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L85 target="_blank"><b>tefla.da.data.brightness_transform</b></a></span>  (img,  brightness_min=0.93,  brightness_max=1.4)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L107 target="_blank"><b>tefla.da.data.build_rescale_transform_slow</b></a></span>  (downscale_factor,  image_shape,  target_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L140 target="_blank"><b>tefla.da.data.build_rescale_transform_fast</b></a></span>  (downscale_factor,  image_shape,  target_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L166 target="_blank"><b>tefla.da.data.build_centering_transform</b></a></span>  (image_shape,  target_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L184 target="_blank"><b>tefla.da.data.build_center_uncenter_transforms</b></a></span>  (image_shape)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L203 target="_blank"><b>tefla.da.data.build_augmentation_transform</b></a></span>  (zoom=  (1.0,  1.0),  rotation=0,  shear=0,  translation=  (0,  0),  flip=False)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L282 target="_blank"><b>tefla.da.data.definite_crop</b></a></span>  (img,  bbox)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L353 target="_blank"><b>tefla.da.data.perturb_fixed</b></a></span>  (img,  tform_augment,  target_shape=  (50,  50),  mode='constant',  mode_cval=0)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L454 target="_blank"><b>tefla.da.data.image_no_preprocessing</b></a></span>  (fname)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L467 target="_blank"><b>tefla.da.data.load_images</b></a></span>  (imgs,  preprocessor=<function  image_no_preprocessing  at  0x7ff5ffd9f1b8>)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L481 target="_blank"><b>tefla.da.data.load_image</b></a></span>  (img,  preprocessor=<function  image_no_preprocessing  at  0x7ff5ffd9f1b8>)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L501 target="_blank"><b>tefla.da.data.save_image</b></a></span>  (x,  fname)</span>
...
<span class="extra_h1"><span style="color:black;"><a href=https://github.com/n3011/tefla/blob/master/tefla/da/data.py#L515 target="_blank"><b>tefla.da.data.balance_per_class_indices</b></a></span>  (y,  weights)</span>
