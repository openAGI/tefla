...
<span class="extra_h1"><span style="color:black;"><b>tefla.core.learning.SupervisedTrainer</b></span>  (model,  cnf,  clip_by_global_norm=False,  **kwargs)</span>
...
<span class="extra_h2"><span style="color:black"><b>fit</b></span>  (data_set,  weights_from=None,  start_epoch=1,  summary_every=10,  keep_moving_averages=False)</span>
